...
// src/clickable-images.ts
var defaultOptions4 = {
  wrapperClass: "lightbox-wrapper",
  imageClass: "lightbox-image",
  enableLightbox: true
};
var rehypeClickableImages = (options) => {
  return () => (tree, _file) => {
    visit(tree, "element", (node2, _index, parent) => {
      if (node2.tagName !== "img" || !parent) return;
      const originalSrc = node2.properties?.src;
      const originalAlt = node2.properties?.alt || "";
      if (!originalSrc) return;
      const existingClasses = node2.properties?.className;
      const classes = Array.isArray(existingClasses) ? existingClasses.filter((v2) => typeof v2 === "string") : typeof existingClasses === "string" ? [existingClasses] : [];
      node2.properties = {
        ...node2.properties,
...
var ClickableImages = (userOptions) => {
...
export { ClickableImages, ExampleComponent_default as ExampleComponent, ExampleEmitter, ExampleFilter, ExampleTransformer };
